...
rebuild_firmware() {
    ...
    kmod-usb-acm luci-proto-ncm comgt comgt-ncm kmod-usb-net-huawei-cdc-ncm kmod-usb-net-cdc-ncm kmod-usb-net-rndis kmod-usb-net-sierrawireless \
    kmod-usb-storage kmod-usb-serial-wwan wwan qmi-utils luci-proto-qmi kmod-usb-serial-qualcomm kmod-usb-net-cdc-mbim umbim luci-proto-mbim \
    modemmanager luci-proto-modemmanager chat kmod-mii xmm-modem libmbim libqmi kmod-usb-ohci kmod-usb-uhci kmod-usb2 kmod-usb-ehci kmod-usb3 kmod-usb-xhci-hcd \
    kmod-phy-broadcom kmod-phylib-broadcom kmod-tg3 iptables-nft base-files bash blkid block-mount blockd btrfs-progs busybox fdisk ntfs-3g \
    cgi-io coreutils coreutils-stty coreutils-timeout coreutils-sleep git git-http curl jq tar tini unzip lsblk \
    f2fs-tools f2fsck mkf2fs e2fsprogs resize2fs htop uhttpd uhttpd-mod-ubus uuidgen wget-ssl zoneinfo-asia zoneinfo-core \
    kmod-brcmfmac kmod-brcmutil jq jshn libjson-script liblucihttp liblucihttp-lua losetup ppp ppp-mod-pppoe \
    ...
    # Tunnel option
    OPENCLASH="coreutils-nohup bash dnsmasq-full curl ca-certificates ipset ip-full libcap libcap-bin ruby ruby-yaml kmod-tun kmod-inet-diag unzip kmod-nft-tproxy luci-app-openclash"
    ...
    PACKAGES+=" internet-detector luci-app-internet-detector internet-detector-mod-modem-restart vnstat2 vnstati2 luci-app-netmonitor luci-app-eqosplus"
    
    # Speedtest
    PACKAGES+=" speedtestcli iperf3"
    # PHP8
