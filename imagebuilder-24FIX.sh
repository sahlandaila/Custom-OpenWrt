...
rebuild_firmware() {
    ...
    PACKAGES+=" usbutils kmod-usb-net usb-modeswitch kmod-usb-wdm kmod-usb-net-qmi-wwan uqmi kmod-usb-net-cdc-ether kmod-usb-serial kmod-usb-serial-option \
    kmod-usb-acm luci-proto-ncm kmod-usb-net-huawei-cdc-ncm kmod-usb-net-cdc-ncm kmod-usb-net-rndis kmod-usb-net-sierrawireless \
    kmod-usb-serial-wwan wwan qmi-utils luci-proto-qmi kmod-usb-serial-qualcomm kmod-usb-net-cdc-mbim umbim luci-proto-mbim \
    modemmanager luci-proto-modemmanager chat kmod-mii xmm-modem libmbim libqmi kmod-usb-ohci kmod-usb-uhci kmod-usb2 kmod-usb-ehci kmod-usb3 \
    kmod-phy-broadcom kmod-phylib-broadcom kmod-tg3 iptables-nft block-mount base-files blkid btrfs-progs busybox curl fdisk \
    cgi-io comgt comgt-ncm coreutils coreutils-stty coreutils-timeout coreutils-sleep fdisk git git-http hostapd-common iw iwinfo jq \
    jshn kmod-brcmfmac kmod-brcmutil kmod-cfg80211 kmod-mac80211 libjson-script liblucihttp liblucihttp-lua losetup ppp ppp-mod-pppoe \
    f2fs-tools f2fsck resize2fs tar unzip htop uhttpd uhttpd-mod-ubus uuidgen wget-ssl zoneinfo-asia zoneinfo-core \
    ...
    PACKAGES+=" kmod-usb-storage ntfs-3g"
    ...
    # PHP8
    PACKAGES+=" libc php8-mod-gettext php8-mod-fileinfo php8-mod-ctype php8-cgi php8 php8-mod-zip \
    php8-mod-session php8-mod-pcntl php8-mod-mbstring php8-mod-iconv php8-mod-gmp tar"
    
    # Misc and some custom .ipk files
    misc+=" luci-app-temp-status luci-theme-argon luci-app-3ginfo-lite luci-app-ipinfo luci-app-rakitanmanager luci-app-tailscale luci-theme-alpha luci-app-mmconfig luci-app-droidnet"
    
    PACKAGES+=" $misc boost-system boost-python3 httping python3 lolcat screen openssh-sftp-server adb luci-app-poweroff luci-app-ramfree luci-app-ttyd luci-app-tinyfm"
...
# Package Wifi Off Sampai kmod-crypto-hash #
    if [ "$op_target" == "amlogic" ]; then
        PACKAGES+=" luci-app-amlogic btrfs-progs kmod-fs-btrfs kmod-crypto-acompress kmod-crypto-crc32c kmod-crypto-hash ath9k-htc-firmware hostapd hostapd-utils kmod-ath kmod-ath9k kmod-ath9k-common kmod-ath9k-htc kmod-cfg80211 kmod-mac80211 wireless-tools wpa-cli wpa-supplicant"
