...
custom_packages() {
    ...
    other_packages=(
        ...
        "sms-tool|https://downloads.$op_sourse.org/releases/23.05.5/packages/$ARCH_3/packages"
...
rebuild_firmware() {
    ...
    PACKAGES+=" usbutils usb-modeswitch kmod-usb-net kmod-usb-wdm kmod-usb-net-qmi-wwan uqmi kmod-usb-net-cdc-ether kmod-usb-serial kmod-usb-serial-option \
    ...
    kmod-usb-uhci kmod-usb2 kmod-usb-ehci kmod-usb3 kmod-usb-xhci-hcd libqmi libmbim modemmanager luci-proto-modemmanager chat kmod-mii xmm-modem \
    kmod-phy-broadcom kmod-phylib-broadcom kmod-tg3 iptables-nft git git-http htop lsblk tar tini unzip \
    bash block-mount blockd btrfs-progs busybox curl f2fs-tools f2fsck fdisk ntfs-3g resize2fs \
