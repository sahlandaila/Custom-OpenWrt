...
rebuild_firmware() {
    ...
    cgi-io comgt comgt-ncm coreutils coreutils-stty coreutils-timeout coreutils-sleep fdisk git git-http jq \
    jshn kmod-brcmfmac kmod-brcmutil libjson-script liblucihttp liblucihttp-lua losetup ppp ppp-mod-pppoe \
    ...
    PACKAGES+=" $misc boost-system boost-python3 httping python3 zram-swap lolcat screen openssh-sftp-server adb luci-app-poweroff luci-app-ramfree luci-app-ttyd luci-app-tinyfm"
